                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('products.update', ['product' => $product->id]) }}">
                            ...
                            {!!Form::input()->setName('supplier_price')->setValue(old('supplier_price',$product->supplier_price))->setLabel('Supplier Price')->setPlaceholder('Supplier Price')->setType('number')->render()!!}
