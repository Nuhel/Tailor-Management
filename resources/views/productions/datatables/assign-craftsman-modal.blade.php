    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Assign Craftsman</h5>
                ...
                <div class="c">
                    <form method="POST" id="asign-craftsman-form">
                        ...
                        <div class="form-group" id="deadline">
                            ...
                            <input name="deadline" class="form-control form-control-sm " type="date" />
                        </div>
...
@push('inner-script')
    <script>
        ...
        var assignCraftsmanModalView = $('#asign-craftsman-modal');
        assignCraftsmanModalView.on('hidden.bs.modal', function(e) {
        ...
        assignCraftsmanModalView.on('show.bs.modal', function(e) {
        ...
        $('#asign-craftsman-form').on('submit', function(event) {
            ...
            bodyFormData.append('deadline', $("input[name='deadline']").val());
            axios({
                    method: "post",
                    url: url,
                    data: bodyFormData,
                ...
                .then(function(response) {
                    ...
                    assignCraftsmanModalView.modal('hide')
                })
