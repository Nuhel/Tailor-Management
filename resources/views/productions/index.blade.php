...
@section('content')
            ...
            <div class="container pt-5">
                <div class="w-100">
                    ...
                    <ul role="tablist" class="nav nav-tabs">
                        <li class="nav-item">
                            <a id="home-tab" data-toggle="tab" href="#pending-tab" role="tab" aria-controls="home"
                                aria-selected="true" class="nav-link active show"
                                data-tableid='{{ $pendingDataTable->getId() }}'>পেন্ডিং</a>
                        </li>
                        <li class="nav-item">
                            <a id="profile-tab" data-toggle="tab" href="#processing-tab" role="tab" aria-controls="profile"
                                aria-selected="false" class="nav-link"
                                data-tableid='{{ $processingDataTable->getId() }}'>প্রসেসিং</a>
                        </li>
                        <li class="nav-item">
                            <a id="p-tab" data-toggle="tab" href="#home-3" role="tab" aria-controls="p"
                                aria-selected="false" class="nav-link"
                                data-tableid='{{ $readyDataTable->getId() }}'>রিসিভ</a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div id="pending-tab" role="tabpanel" aria-labelledby="pending-tab"
                            class="tab-pane fade active show">

                            @include('productions.datatables.pending', [
                                'heading' => 'Pendign',
                                'craftMans' => $craftMans,
                        ...
                        <div id="processing-tab" role="tabpanel" aria-labelledby="processing-tab" class="tab-pane fade">
                            @include('productions.datatables.processing', [
                                'heading' => 'Processing',
                        ...
                        <div id="home-3" role="tabpanel" aria-labelledby="home-tab" class="tab-pane fade">
                            @include('productions.datatables.ready', [
                                'heading' => 'Ready',
    ...
    @include('productions.datatables.assign-craftsman-modal', [
        'craftMans' => $craftMans,
        'tableIds' => [
            $pendingDataTable->getId(),
            $processingDataTable->getId(),
    ...
    @include('productions.take-payment-modal', [
        'tableIds' => [$pendingDataTable->getId(), $processingDataTable->getId(), $readyDataTable->getId()],
    ])
@endsection
