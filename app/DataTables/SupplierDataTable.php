...
class SupplierDataTable extends DataTable
{
    ...
    protected $tableId = 'supplier-table';
    ...
    public function dataTable(Request $request,$query)
    {
        ...
        return datatables()
            ...
            ->addColumn('actions', function(Supplier $supplier) {
                return view('components.actionbuttons.table_actions')->with('route','suppliers')->with('param','supplier')->with('value',$supplier)->render();
            })
            ->addIndexColumn()
            ->rawColumns(['actions']);
    }
